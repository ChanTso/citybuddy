...
The full per-slice pitfall record kept during the 2026-07 to 2026-08 slice process, in the language
it was written in. It records only factual pitfalls supported by merged pull-request, commit, or

...
This directory holds the development-process records used from 2026-07 to 2026-08. They are
kept for history and are not part of the current ruleset or repository index.

- `ROUTE_HISTORY.md` — the former slice route index, including per-slice status and the
  terminal outcome of the seckill-measurement attempts.
- `slices/` — the 49 per-slice specifications the route linked.

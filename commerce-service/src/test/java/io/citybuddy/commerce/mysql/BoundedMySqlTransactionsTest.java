...
class BoundedMySqlTransactionsTest {
  ...
  @Test
  void rejectsAnUnboundedPhysicalPolicy() {
    assertThatThrownBy(
            () ->
                new BoundedMySqlTransactions(
                    mock(JdbcTemplate.class), mock(TransactionTemplate.class), 0))
        .isInstanceOf(IllegalArgumentException.class);
    assertThatThrownBy(
            () ->
                new BoundedMySqlTransactions(
                    mock(JdbcTemplate.class), mock(TransactionTemplate.class), 61))
        .isInstanceOf(IllegalArgumentException.class);
  }

...
modeled_context_payload="JSON_OBJECT('policyVersion', 'session-context-v1', 'tokenEstimator', 'utf8-bytes-v1', 'tokenBudget', 6144, 'tokenWatermark', 'low', 'candidateTokens', 0, 'includedTokens', 0, 'loadedTurnCount', 0, 'includedTurnIds', JSON_ARRAY(), 'omittedLoadedTurnCount', 0, 'olderTurnsAvailable', false)"
modeled_routing_payload="JSON_OBJECT('signals', JSON_OBJECT('refundContext', false, 'refundContextSource', 'none', 'chitchat', false), 'tier', 'standard', 'attemptLimit', 16, 'toolProfile', 'read', 'sessionPropagationEnabled', true)"

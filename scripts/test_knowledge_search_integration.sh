...
probe_expected='{"alias":"knowledge_docs_read","callerIndexRejected":true,"denseRecall":"passed","indexVersion":"knowledge_docs_v1","mixedLanguageBm25":"passed","realBoundedResultCount":5,"realRrfTieOrder":"passed","rrfRepeatable":true}'
probe_output="$(

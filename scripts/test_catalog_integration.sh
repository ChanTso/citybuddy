...
echo "Verified CB-118 upgrade reaches the exact action-extended runtime grant state."
...
assert_mysql_fails "commerce_app cannot update immutable PendingAction commitment" \
  '(UPDATE command denied|Access denied)' \
  mysql_query commerce_app "$commerce_app_password" commerce_db \
  "UPDATE pending_action SET pending_hash = REPEAT('0', 64) WHERE pending_action_id = 'none'"
...
required_surefire_classes=(
  ...
  io.citybuddy.commerce.evaluation.EvaluationShoppingReadIntegrationTest
  io.citybuddy.commerce.cart.CartIntegrationTest
  io.citybuddy.commerce.checkout.CheckoutIntegrationTest
  io.citybuddy.commerce.merchant.MerchantOrderIssueIntegrationTest
  io.citybuddy.commerce.merchant.MerchantOrderIntegrationTest
  io.citybuddy.commerce.shopping.ShoppingPreferencesIntegrationTest
  io.citybuddy.commerce.retail.RetailFactsIntegrationTest
)
...
docker run --rm \
  ...
  -pl commerce-service \
  -Dtest=CatalogIntegrationTest,FaqPublicationIntegrationTest,FaqFixturePublisherIntegrationTest,SeckillIntegrationTest,SeckillReservationIntegrationTest,SeckillTransactionIntegrationTest,MockPaymentIntegrationTest,RefundIntegrationTest,ActionIntegrationTest,MerchantIntegrationTest,MerchantChangeIntegrationTest,MerchantProductOperationsIntegrationTest,MerchantListingIntegrationTest,MerchantMarketingIntegrationTest,RetailCatalogPaginationIntegrationTest,ShoppingOrderIntegrationTest,EvaluationShoppingReadIntegrationTest,CartIntegrationTest,CheckoutIntegrationTest,MerchantOrderIssueIntegrationTest,MerchantOrderIntegrationTest,ShoppingPreferencesIntegrationTest,RetailFactsIntegrationTest test

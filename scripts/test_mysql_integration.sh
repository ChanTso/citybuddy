...
expected_commerce_history="$(find infra/mysql/migrations/commerce -maxdepth 1 -type f -name 'V*__*.sql' | wc -l | tr -d ' ')"
...
test "$commerce_history" = "$expected_commerce_history"

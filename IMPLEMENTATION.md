...
**Repository phase:** Support conversation lifecycle verified; bounded agent ready
...
| [CB-081 — Bounded agent, model routing, and ToolSpec control](docs/slices/CB-081.md) | P0 | `READY` | `CB-080` |

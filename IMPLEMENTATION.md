...
**Repository phase:** CB-151 and CB-152 are BLOCKED. CB-153 and CB-154 remain PLANNED. There is
no READY or IN_PROGRESS slice; CB-152 exhausted its two-cycle recovery budget without review closure.
...
| [CB-116 — Committed payment truth closure and authorization visibility](docs/slices/CB-116.md) | P1 | `VERIFIED` | `CB-071`, `CB-105` |
